...
class BarkingDog extends ClassReference {
    ...
    static public ClassReference newClass() {
        ...
        if (Environment.traceLevel > 0)
          System.out.println( "BarkingDog class object: construction begins" );
        ...
        if ( classObject == null ) {
            ...
            if (Environment.traceLevel > 0)
              System.out.println( "BarkingDog class object: construction completed" );
        }
        return classObject;
    }
}
