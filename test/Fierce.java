...
class Fierce extends ClassReference {
    ...
    static public ClassReference newClass() {
        ...
        if (Environment.traceLevel > 0)
          System.out.println( "Fierce class object: construction begins" );
        ...
        if ( classObject == null ) {
            ...
            classObject.invoke( Environment.Class, "overrideMethod", BeforeAfter.classObject, "beforeMethod", new FierceCodePtr_beforeMethod() );

            classObject.invoke( Environment.Class, "overrideMethod", BeforeAfter.classObject, "afterMethod", new FierceCodePtr_afterMethod() );

            classObject.invoke( Environment.Class, "readyClass" );


            if (Environment.traceLevel > 0)
              System.out.println( "Fierce class object: construction completed" );
        }
        return classObject;
    }
}
...
class FierceCodePtr_beforeMethod      extends CodePtr { 
    public Object execute( ObjectReference target, Object param1, Object param2, Object param3, Object param4 ) {
        ...
        System.out.println( "GRRR" + traceString );
        return new Long(0);
    }
    public String toString() { return "FierceCodePtr_beforeMethod";} 
}


class FierceCodePtr_afterMethod      extends CodePtr { 
    ...
    public String toString() { return "FierceCodePtr_afterMethod";} 
}
